...
:: Start the renderer
START /B "" CMD /C ".\engine.cmd" ^& EXIT

:: Start a second background buffer for animations and such
START /B "" CMD /C ".\ball.cmd" ^& EXIT
...
) > .\buffer_layer_2.cmd || GOTO RENDER_PLAYER-RE
) >NUL
ENDLOCAL
EXIT /B 0
...
:EXIT
DEL /Q ".\buffer_layer_1.cmd"
IF EXIST ".\buffer_layer_1.cmd" GOTO EXIT
DEL /Q ".\buffer_layer_2.cmd"
IF EXIST ".\buffer_layer_2.cmd" GOTO EXIT
DEL /Q ".\buffer_layer_3.cmd"
IF EXIST ".\buffer_layer_3.cmd" GOTO EXIT
DEL /Q ".\buffer_layer_4.cmd"
IF EXIST ".\buffer_layer_4.cmd" GOTO EXIT
TIMEOUT /T 0 /NOBREAK >NUL
CALL ".\clear.cmd"
EXIT /B 0