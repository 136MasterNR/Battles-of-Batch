...
ECHO(%ARG% | FINDSTR /C:"/?">NUL && (
	ECHO.
	ECHO.Examples:
	ECHO.  script SAVE "FILE=%%PLAYERDATA.LOAD%%" 1 /A PLAYER.MONEY= 500  -^>  Set your player Money to 500
	ECHO.  script SAVE "FILE=%%PLAYERDATA.LOAD%%" 1 /A PLAYER.XP= 1200    -^>  Sets your player XP to 1200.
