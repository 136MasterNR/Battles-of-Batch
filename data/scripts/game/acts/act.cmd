...
ENDLOCAL&CALL "%SCRIPTS_GAME%\logger.cmd" ADD You striked [4m%TMP.ENEMY%[24m ^(#%INPUTATK%^) using %RGB.YELLOW%%TMP.WEAPON:_= %[0m!%RGB.YELLOW%[0m
EXIT /B 0
...
CALL "%SCRIPTS_GAME%\logger.cmd" ADD You striked [4mall enemies[24m using %RGB.YELLOW%Bomb[0m%RGB.YELLOW%[0m
EXIT /B 0
:Bomb-CALC
