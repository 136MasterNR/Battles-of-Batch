...
SET /A "PLAYER.HEAL.AMOUNT=%random% %% 15 +5"
IF NOT %PLAYER.HP.NOW% GEQ 100 SET /A "PLAYER.HP.NOW=%PLAYER.HP.NOW% +%PLAYER.HEAL.AMOUNT%"
IF %PLAYER.HP.NOW% GTR 100 (
	SET /A "PLAYER.HP.NOW=100"
