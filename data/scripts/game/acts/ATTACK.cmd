...
SET /A "ATK.CRIT=%random% %% %CRIT.STRE% +40" 5
IF %CRIT.CHANCE% GTR %CRIT.RATE% ( SET ATK.CRIT=+0 ) ELSE ( SET ATK.CRIT=+%ATK.CRIT%)
SET /A "PLAYER.ATTACK.CNT1=(50*%SKILL.ATK%)/2"
SET /A "PLAYER.ATTACK.AMOUNT=%random% %% %PLAYER.ATTACK.CNT1% +%PLAYER.ATTACK.CNT1% %ATK.CRIT%"
ECHO.[15A
