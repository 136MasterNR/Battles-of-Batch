...
ECHO.[32A[3C%RGB%255;255;255mBomb[0m : %C_MONELOCKED%100[0m : %C_LVLLOCKED%↑%C_LVLLOCKED.NUM%%SHOP.LVLREQ.BOMB%[0m        [%RGB%143;186;194m%PLAYER.ITEM.BOMB%[0m/%RGB%143;186;194m%SHOP.MAX.BOMB%[0m]
...
ECHO.[1A[82C%RGB%255;255;255mHeal[0m : %C_MONELOCKED%10[0m : %C_LVLLOCKED%↑%C_LVLLOCKED.NUM%%SHOP.LVLREQ.HEAL%[0m         [%RGB%143;186;194m%PLAYER.ITEM.HEAL%[0m/%RGB%143;186;194m%SHOP.MAX.HEAL%[0m]
GOTO :EOF