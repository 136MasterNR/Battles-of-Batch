...
:INPUT
SET /A CNT+=1
::ECHO.KEY"!KEY!" INPUT"!INPUT!" CNT"%CNT%">>DATA.log
SET "KEY="
...
IF "%INPUT_PART%"=="menu" (
	IF /I "%INPUT:~1%"=="PLAY" CALL :SUPERHIGHTLIGHT %RGB%128;210;255m
	IF /I "%INPUT:~1%"=="START" CALL :SUPERHIGHTLIGHT %RGB%128;210;255m
	IF /I "%INPUT:~1%"=="SHOP" CALL :SUPERHIGHTLIGHT %RGB%105;255;147m
	IF /I "%INPUT:~1%"=="SKILLS" CALL :SUPERHIGHTLIGHT %RGB%105;255;147m
	IF /I "%INPUT:~1%"=="ITEMS" CALL :SUPERHIGHTLIGHT %RGB%105;255;147m
	IF /I "%INPUT:~1%"=="OPTIONS" CALL :SUPERHIGHTLIGHT %RGB%249;241;165m
	IF /I "%INPUT:~1%"=="SETTINGS" CALL :SUPERHIGHTLIGHT %RGB%249;241;165m
	IF /I "%INPUT:~1%"=="SETTING" CALL :SUPERHIGHTLIGHT %RGB%249;241;165m
	IF /I "%INPUT:~1%"=="OPTION" CALL :SUPERHIGHTLIGHT %RGB%249;241;165m
	IF /I "%INPUT:~1%"=="PREFERENCE" CALL :SUPERHIGHTLIGHT %RGB%249;241;165m
	IF /I "%INPUT:~1%"=="PREFERENCES" CALL :SUPERHIGHTLIGHT %RGB%249;241;165m
	IF /I "%INPUT:~1%"=="SET" CALL :SUPERHIGHTLIGHT %RGB%249;241;165m
	IF /I "%INPUT:~1%"=="QUESTS" CALL :SUPERHIGHTLIGHT %RGB%138;167;255m
	IF /I "%INPUT:~1%"=="MAP" CALL :SUPERHIGHTLIGHT %RGB%128;210;255m
	IF /I "%INPUT:~1%"=="FIGHT" CALL :SUPERHIGHTLIGHT %RGB%128;210;255m
	IF /I "%INPUT:~1%"=="BATTLE" CALL :SUPERHIGHTLIGHT %RGB%128;210;255m
	IF /I "%INPUT:~1%"=="START GAME" CALL :SUPERHIGHTLIGHT %RGB%128;210;255m
	IF /I "%INPUT:~1%"=="HTS" CALL :SUPERHIGHTLIGHT %RGB.FALSE%
	IF /I "%INPUT:~1%"=="CHEATS" CALL :SUPERHIGHTLIGHT [1;30m
	IF /I "%INPUT:~1%"=="CREDITS" CALL :SUPERHIGHTLIGHT [1;30m
	IF /I "%INPUT:~1%"=="CMD" CALL :SUPERHIGHTLIGHT [1;30m
	IF /I "%INPUT:~1%"=="EXIT" CALL :SUPERHIGHTLIGHT %RGB.FALSE%
	IF /I "%INPUT:~1%"=="QUIT" CALL :SUPERHIGHTLIGHT %RGB.FALSE%
	IF /I "%INPUT:~1%"=="RESTART" CALL :SUPERHIGHTLIGHT %RGB.FALSE%
	IF /I "%INPUT:~1%"=="RE" CALL :SUPERHIGHTLIGHT [1;30m
	IF "%INPUT:~1%"=="FUCK YOU" (
		SET "EXTENDED_HIGHLIGHT=[3DME "
		CALL :SUPERHIGHTLIGHT %RGB.FALSE%
	) ELSE IF /I "%INPUT:~1%"=="FUCK YOU" (
		SET "EXTENDED_HIGHLIGHT=[3Dme "
		CALL :SUPERHIGHTLIGHT %RGB.FALSE%
	)
	IF /I "%INPUT:~1%"=="I HATE THIS GAME" (
		SET "EXTENDED_HIGHLIGHT=[16D%RGB.TRUE%I LOVE THIS GAME[1;37m"
		CALL :SUPERHIGHTLIGHT %RGB.FALSE%
	)
)
IF "%INPUT_PART%"=="map" (
	IF /I "%INPUT:~1,8%"=="CHAPTER " (
		SET "HIGHLIGHT=%RGB.LVL%"
		>CON <NUL SET /P "=.[u!HIGHLIGHT!%INPUT:~1,8%%RGB.COIN%%INPUT:~9%[1;37m [1D"
	) ELSE IF /I "%INPUT:~1%"=="CHAPTER" CALL :SUPERHIGHTLIGHT %RGB.LVL%
	IF /I "%INPUT:~1%"=="START" CALL :SUPERHIGHTLIGHT %RGB.TRUE%
	IF /I "%INPUT:~1%"=="PLAY" CALL :SUPERHIGHTLIGHT %RGB.TRUE%
	IF /I "%INPUT:~1%"=="EXIT" CALL :SUPERHIGHTLIGHT %RGB.FALSE%
	IF /I "%INPUT:~1%"=="QUIT" CALL :SUPERHIGHTLIGHT %RGB.FALSE%
	IF /I "%INPUT:~1%"=="BACK" CALL :SUPERHIGHTLIGHT %RGB.FALSE%
	IF /I "%INPUT:~1%"=="RE" CALL :SUPERHIGHTLIGHT [1;30m
	IF /I "%INPUT:~1%"=="FORWARD" CALL :SUPERHIGHTLIGHT %RGB.LVL%
	IF /I "%INPUT:~1%"=="PREV" CALL :SUPERHIGHTLIGHT %RGB.LVL%
)
IF "%INPUT_PART%"=="items" (
