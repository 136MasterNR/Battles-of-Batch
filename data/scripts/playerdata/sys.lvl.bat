...
IF %PLAYER.LVL% LSS 60 (
	...
	IF %PLAYER.LVL% LEQ 9 (SET /A PLAYER.XP.REQ=PLAYER.XP.REQ*5) ELSE IF %PLAYER.LVL% LEQ 35 (SET /A PLAYER.XP.REQ=PLAYER.XP.REQ*4) ELSE SET /A PLAYER.XP.REQ=PLAYER.XP.REQ*3
