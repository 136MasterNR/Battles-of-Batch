...
IF DEFINED WIELDING.WEAPON CALL SET /A EQUIP.BONUS_ATK=%%I.%EQUIP.BONUS_ATK%.DMG%%*WIELDING.WEAPON_LVL
EXIT /B 0
:WEAPONS_REG
SET /A CNT+=1
SET VAR.IS=%1
...
SET MAX=%2
SET CRAFT.I_OWNED=%5
IF %5.==. SET CRAFT.I_OWNED=%5
SET /A ADD_MAX_ITEMS=%4-%5
