...
IF ERRORLEVEL 60 IF DEFINED LOOT.1 ECHO.%LOOT.1%$%LOOT.1.X%>>"!PLAYERDATA.%LOOT.1.SAV%!"
CALL "%ITEMS.LOADER%" REPLACE-MAT %LOOT.2% %LOOT.2.X% %LOOT.2.SAV%
IF ERRORLEVEL 60 IF DEFINED LOOT.2 ECHO.%LOOT.2%$%LOOT.2.X%>>"!PLAYERDATA.%LOOT.2.SAV%!"
ENDLOCAL
)
CALL "%PLAYERDATA.XP%"
