...
:: Increase quest value
CALL "%QUESTS%" ADD TOTAL_LVLS 1
...
SETLOCAL ENABLEDELAYEDEXPANSION
%TITLE%!MAP.NAME.%SELECTED%:_= ! ^(#%SELECTED%^) - Won The Battle
ENDLOCAL
PAUSE>NUL
EXIT /B 0
...
:DISPLAY-LOOT
SETLOCAL ENABLEDELAYEDEXPANSION
IF %TMP.FIRST%==TRUE IF !LOOT.%1.ONCE!==FALSE SET /A LOOT.%1.X*=2
IF !LOOT.%1.X! EQU 0 (
	ENDLOCAL
	EXIT /B 0
)
