...
SET "ERRORLEVEL="
SET "ERRORLVL="
IF %AUDIO.VALUE%==TRUE IF %VOLUME% NEQ 0 ( SET "ERRORLEVEL="&TASKLIST /FI "IMAGENAME eq wscript.exe*" 2>NUL|FIND /I /N "wscript.exe">NUL&SET "ERRORLVL=%ERRORLEVEL%" & TASKKILL /F /IM wscript.exe>NUL ) ELSE ( SET ERRORLVL=NUL & TASKKILL /F /IM wscript.exe*>NUL )
