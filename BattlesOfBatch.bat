...
SET "PLAYERDATA.ITEMS=%DATA_SAVES%\ITEMS.cmd"
...
IF NOT EXIST "%MAIN_GAME%\LICENSEAGREEMENT.dll" IF EXIST "%LICENSE%" (
	...
	ECHO.Using a product without a lisence is legally disallowed.
	ECHO.
	ECHO.Please consider reinstalling this product.
	ECHO.If this solution does not help, please contact us.
	PAUSE>NUL
	EXIT 0
)
