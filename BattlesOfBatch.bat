...
SET SKILL.ATK.LVLS=1;7;10;14;17
SET SKILL.ATK.COST=44;784;1520;5800;20000
...
SET SKILL.HP.LVLS=4;10;13;15;18;24
SET SKILL.HP.COST=250;2400;7000;15000;48000;120000
...
IF /I %CHOICE.INPUT%==TIMEOUT (MODE CON:COLS=%COLS% LINES=%LINES%&GOTO MENU)
IF /I %CHOICE.INPUT%== (
...
IF /I %CHOICE.INPUT%.==R. (MODE CON:COLS=%COLS% LINES=%LINES%&GOTO CHARACTER-REFRESH)
IF /I %CHOICE.INPUT%==TIMEOUT (MODE CON:COLS=%COLS% LINES=%LINES%&GOTO CHARACTER-REFRESH)
...
SET /P "=[2;3H[?25h"<NUL
%CHOICE%
IF /I %CHOICE.INPUT%.==R. (MODE CON:COLS=%COLS% LINES=%LINES%&GOTO PROFILES)
IF /I %CHOICE.INPUT%==TIMEOUT (MODE CON:COLS=%COLS% LINES=%LINES%&GOTO PROFILES)
...
IF %PROFILE_COUNTER% GEQ 4 (
	...
	ECHO.[34C┃                                             ┃
	ECHO.[34C┃  You have reached the maximum amount of[0m     ┃
	ECHO.[34C┃  profiles and %RGB.PINK%cannot create any more[0m!       ┃
	ECHO.[34C┃                                             ┃
	ECHO.[34C┠╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┨
	ECHO.[34C┃     Delete some profiles and try again.     ┃
	ECHO.[34C┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
	ECHO.
...
IF EXIST "%MAIN_GAME%\SAVES\%UDERFINE%" (
	...
	ECHO.[?25l[0m[18;35H┏━━━━━━━━━━━━━━━━━━━┫%RGB.RED%ERROR[0m┠━━━━━━━━━━━━━━━━━━━┓
	ECHO.[34C┃                                             ┃
	ECHO.[34C┃         The profile %RGB.PINK%already exists[0m!         ┃
	ECHO.[34C┃                                             ┃
	ECHO.[34C┠╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┨
	ECHO.[34C┃           Choose a different name,          ┃
	ECHO.[34C┃            or delete the profile.           ┃
	ECHO.[34C┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
	ECHO.
...
IF %PROFILE%==%1 (
	...
	ECHO.[34C┃                                             ┃
	ECHO.[34C┃  This is your currently active profile[0m,     ┃
	ECHO.[34C┃  and %RGB.PINK%cannot be deleted[0m!                     ┃
	ECHO.[34C┃                                             ┃
	ECHO.[34C┠╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┨
	ECHO.[34C┃  Activate another profile, then try again.  ┃
	ECHO.[34C┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
...
IF /I %CHOICE.INPUT%==Q GOTO S-MENU
IF /I %CHOICE.INPUT%==R (MODE CON:COLS=%COLS% LINES=%LINES%&GOTO MAP)
IF /I %CHOICE.INPUT%==TIMEOUT (MODE CON:COLS=%COLS% LINES=%LINES%&GOTO MAP)
...
IF /I %CHOICE.INPUT%==Q GOTO S-MENU
IF /I %CHOICE.INPUT%==R (MODE CON:COLS=%COLS% LINES=%LINES%&GOTO SHOP)
IF /I %CHOICE.INPUT%==TIMEOUT (MODE CON:COLS=%COLS% LINES=%LINES%&GOTO SHOP)
IF /I %CHOICE.INPUT%==Z (
	SET /A SHOP.TAB=1
	GOTO SHOP
)
...
IF /I %CHOICE.INPUT%==R (CALL :CLEAR_INFO_SELECTION&MODE CON:COLS=%COLS% LINES=%LINES%&GOTO IN-BATTLE)
IF /I %CHOICE.INPUT%==TIMEOUT (CALL :CLEAR_INFO_SELECTION&MODE CON:COLS=%COLS% LINES=%LINES%&GOTO IN-BATTLE)
